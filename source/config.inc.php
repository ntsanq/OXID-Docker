...
$this->dbName = 'oxid_example'; // database name
$this->dbUser = 'sang'; // database user name
$this->dbPwd  = '123123Nfq!'; // database user password
$this->dbDriverOptions = []; // database driver options
$this->dbUnixSocket = null; // unix domain socket, optional
$this->sShopURL     = 'http://oxid.localhost'; // eShop base url, required
$this->sSSLShopURL  = null;            // eShop SSL url, optional
$this->sAdminSSLURL = null;            // eShop Admin SSL url, optional
$this->sShopDir     = '/var/www/oxid-example/source';
$this->sCompileDir  = '/var/www/oxid-example/source/tmp';
